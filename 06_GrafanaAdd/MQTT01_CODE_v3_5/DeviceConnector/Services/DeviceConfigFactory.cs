...
public static class DeviceConfigFactory
{
        ...
        string deviceName = "SimDevice01")
    {
        return new UnifiedDeviceConfig
        {
            ...
            {
                // Monetoring Group (Read) - KEPServerEX 실제 태그 그룹 이름
                ["Temper"] = new TagDefinition 
                { 
                    Group = "Monetoring", 
                ...
                ["Alam01"] = new TagDefinition 
                { 
                    Group = "Status", 
                    Direction = TagDirection.ReadWrite, 
                    DataType = typeof(bool) 
                },
                ["Alam02"] = new TagDefinition 
                { 
                    Group = "Status", 
                    Direction = TagDirection.ReadWrite, 
                    DataType = typeof(bool) 
        ...
        string deviceName = "ESP32_01")
    {
        return new UnifiedDeviceConfig
        {
            ...
            Tags = new Dictionary<string, TagDefinition>
            {
                ...
                { 
                    Direction = TagDirection.ReadWrite,  // Write → ReadWrite
