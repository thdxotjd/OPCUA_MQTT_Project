...
namespace DeviceConnector.Mqtt.Interfaces
{
    ...
    public interface IMqttPublisherService : IDisposable
    {
        ...
        /// <summary>MQTT 연결 설정</summary>
        MqttConnectionInfo ConnectionInfo { get; }

        /// <summary>MQTT 토픽 설정</summary>
        ...
        /// <summary>MQTT 브로커에 연결</summary>
        Task<bool> ConnectAsync();

        /// <summary>MQTT 브로커 연결 해제</summary>
